...
export function GoogleSignIn(props) {
  ...
  function signInPopupToggle() { 
    signInPopup.current.style.display === "none"
      ? signInPopup.current.style.display = "flex"
      : signInPopup.current.style.display = "none"
  }
  ...
  return (
    <React.Fragment>
      ...
      <div id="signInPopup" ref={signInPopup} className={classes.signInPopup} style={{display: "none"}}>
